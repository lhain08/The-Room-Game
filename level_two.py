...
class room(object):
    def __init__(self,message,death,Victory):
...
class empty(room):
    def __init__(self,up,right,down,left):
        room.__init__(self,'Empty Room',False,False)
        self.up=up
        self.right=right
        self.down=down
        self.left=left
...
class termination(room):
    def __init__(self):
        room.__init__(self,'You Died',True,False)
class victory(room):
    def __init__(self):
        room.__init__(self,'Congratulations! You Win!',False,True)



r0=empty(None,1,None,11)
r1=empty(None,None,2,0)
r2=empty(1,3,None,None)
r3=empty(None,None,4,2)
r4=empty(3,None,5,None)
r5=empty(4,None,None,6)
r6=empty(None,5,None,7)
...
rt=termination()
rv=victory()
rooms=[r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,rt,rv]
global curroom
curroom=0
def UP():
    global curroom
